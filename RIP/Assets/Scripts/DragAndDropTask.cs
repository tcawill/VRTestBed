...
public class DragAndDropTask : MonoBehaviour
{
    ...
    {
        innerSphere.transform.position = LeftHand.transform.position;
    }
    void stretchTargetRight()
    {
        innerSphere.transform.position = RightHand.transform.position;
    }

    void SwitchScenes()
    {
        SceneManager.LoadScene("SteeringTask");
    }
}
